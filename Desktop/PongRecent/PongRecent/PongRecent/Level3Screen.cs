...
namespace PongRecent
{
    ...
    class Level3Screen : GameScreen
    {
        ...
        /// Constructor.
        /// </summary>
        public Level3Screen(bool hand, int difficulty)
        {
            levelNumber = false;
            level3 = new Level3(levelNumber, hand, difficulty);
        }
        ...
        public override void LoadContent()
        {
            ...
            //Game
            level3.LoadContent(content, ScreenManager.GraphicsDevice);
        }
        ...
        public override void HandleInput(InputState input)
        {
            ...
            if (level3.positionWorked == true)
            {
                ScreenManager.AddScreen(new PauseMenuScreen(), ControllingPlayer);
            }
            else if (level3.userWantsToQuit == true)
            {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            level3.Draw(gameTime, spriteBatch);
            //level3.Draw(gameTime, spriteBatch);
            //spriteBatch.Begin();
